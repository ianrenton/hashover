<?php
	...
	// Various Settings
	$root_dir	= 'https://comments.ianrenton.com/hashover/';					// HTTP root directory for comments
	$language	= 'en';						// Language used for forms, buttons, links, and tooltips
	$name		= 'Anonymous';				// Nickname when one isn't given
	...
	$icon_size	= '80';						// Size of Gravatar icons in pixels
	...
	$domain		= 'ianrenton.com';			// Domain name for refer checking & notifications
	$mode		= (isset($mode)) ? $mode : 'javascript';	// Content output type
	$noreply_email	= 'comments@comments.ianrenton.com';			// E-mail used when no e-mail is given by the author
